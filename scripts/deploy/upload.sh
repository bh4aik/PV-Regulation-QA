...
# ============================================================
# 用法（真实服务器，环境变量方式，避免在仓库中硬编码服务器信息）：
#   PVQA_SERVER_IP=8.210.74.191 \
#   PVQA_PUBLIC_URL=https://pv.izturn.me \
#   bash scripts/deploy/upload.sh
# 参数：
#   PVQA_SERVER_IP   必填，服务器公网 IP
#   PVQA_SERVER_USER 可选，默认 root
#   PVQA_APP_DIR     可选，默认 /opt/pvqa
#   PVQA_PUBLIC_URL  可选，默认 https://pv.example.com
# ============================================================
set -e
